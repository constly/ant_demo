...
#include "bp_drawing.h"
#include "imgui_internal.h"

namespace imguilua {

	void Blueprint::DrawPinIcon(EPinType pin_type, bool connected, int alpha, float scale) {
		IconType iconType;
		ImColor  color = GetIconColor(pin_type);
    ...
    void Blueprint::DrawIcon(ImDrawList* drawList, const ImVec2& a, const ImVec2& b, IconType type, bool filled, ImU32 color, ImU32 innerColor) {
	...
	void Blueprint::Icon(const ImVec2& size, IconType type, bool filled, const ImVec4& color/* = ImVec4(1, 1, 1, 1)*/, const ImVec4& innerColor/* = ImVec4(0, 0, 0, 0)*/) {
    ...
    ImColor Blueprint::GetIconColor(EPinType InType) {
		switch (InType) {
		    default:
