...
local function new(api)
	...
	api.reg_data_center_rpc(api.rpc_apply_npc_data, 
	...
	api.reg_data_center_rpc(api.rpc_restart, 
	...
	api.reg_data_center_rpc(api.rpc_set_move_dir, 
		function(player, tbParam)
	...
	-- 进入区域
	api.reg_data_center_rpc(api.rpc_apply_region, 
		function(player, tbParam)
	...
	-- 退出区域
	api.reg_data_center_rpc(api.rpc_exit_region, 
		function(player, tbParam)
