...
function api.update()
	...
	bgfx.dbg_text_print(5, 0, 0x0f, "Color can be changed with ANSI \x1b[9;me\x1b[10;ms\x1b[11;mc\x1b[12;ma\x1b[13;mp\x1b[14;me\x1b[0m code too.");
	...
	bgfx.dbg_text_print(5, 1, 0x0f, string.format("Backbuffer %dW x %dH in pixels, debug text %dW x %dH in characters.",
