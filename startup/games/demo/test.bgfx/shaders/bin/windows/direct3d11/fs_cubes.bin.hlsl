...
// ..\..\..\..\..\bin\msvc\Release\shaderc.exe --platform windows --type fragment -p s_5_0 -f cubes\fs_cubes.sc -o bin\windows\direct3d11\fs_cubes.bin --depends -i ..\..\..\..\..\..\ant\pkg\ant.resources\shaders --debug
