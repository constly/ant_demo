...
// ..\..\..\..\..\bin\msvc\Release\shaderc.exe --platform windows --type vertex -p s_5_0 -f mesh\vs_mesh.sc -o bin\windows\direct3d11\vs_mesh.bin --depends -i ..\..\..\..\..\..\ant\pkg\ant.resources\shaders --debug
