...
// ..\..\..\..\..\bin\msvc\Release\shaderc.exe --platform windows --type vertex -p s_5_0 -f fullquad\vs_quad.sc -o bin\windows\direct3d11\vs_quad.bin --depends -i ..\..\..\..\..\..\ant\pkg\ant.resources\shaders --debug
...
Output main( uint gl_VertexID : SV_VertexID) { Output _varying_; _varying_.v_texcoord0;
{
float2 coord = float2(
float((gl_VertexID & 1) << 2),
float((gl_VertexID & 2) << 1));
_varying_.v_texcoord0 = coord * 0.5;
_varying_.gl_Position = float4(coord - 1.0, 0.0, 1.0);
} return _varying_;
}
