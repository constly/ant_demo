...
// ..\..\..\..\..\bin\msvc\Release\shaderc.exe --platform windows --type vertex -p s_5_0 -f cubes\vs_cubes.sc -o bin\windows\direct3d11\vs_cubes.bin --depends -i ..\..\..\..\..\..\ant\pkg\ant.resources\shaders --debug
