...
void util::BlueprintNodeBuilder::BeginHorizontal(const void* ptr_id) {
	BeginHorizontal(0);
}

void util::BlueprintNodeBuilder::BeginHorizontal(int id) {
	ImGui::BeginGroup();
	ImGui::PushStyleVar(ImGuiStyleVar_ChildRounding, 0.0f);
	ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(0.0f, 0.0f));
}
	
void util::BlueprintNodeBuilder::EndHorizontal() {
	ImGui::PopStyleVar(2);
	ImGui::EndGroup();
}

void util::BlueprintNodeBuilder::BeginVertical(const char* str_id, const ImVec2& size, float align) {
	ImGui::BeginGroup();
}

void util::BlueprintNodeBuilder::EndVertical() {
	ImGui::EndGroup();
}