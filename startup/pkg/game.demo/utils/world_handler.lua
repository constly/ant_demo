...
function world_handler.create_instance(p, on_ready)
...
function world_handler.prefab_entities(p)
    local e = {}
...
function world_handler.remove_entities(e)
...
local PROXY_MT = {
    ...
    clear = function (self)
        world_handler.remove_entities(self._entities)
        self._entities = {}
...
function world_handler.proxy_creator()
